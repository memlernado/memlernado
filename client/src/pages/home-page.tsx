            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <h3 className="text-lg font-medium text-foreground mb-2">
                  {t("home.workspaces.noWorkspaces.title")}
                </h3>
                ...
                >
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant="secondary">
                        {t("home.workspaces.workspace.active")}
                      </Badge>
                    </div>
                  ...
                  <CardContent>
                    <div className="flex items-center justify-between text-sm text-muted-foreground">
                      <span>
                        {t("home.workspaces.workspace.learners", {
                          count: workspace.learnerCount || 0,
                        })}
                      </span>
                      <span>
                        {t("home.workspaces.workspace.sprints", {
                          count: workspace.activeSprintCount || 0,
                        })}
                      </span>
                    </div>
                    <div className="mt-3">
          ...
          <Card>
            <CardContent className="py-12">
              <div className="text-center">
                ...
                <h3 className="text-lg font-medium text-foreground mb-2">
                  {t("home.recentActivity.noActivity.title")}
                </h3>
